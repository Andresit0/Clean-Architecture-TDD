...
// in clean_architecture/test/config/functions/request_test.dart.
// Do not manually edit this file.

// ignore_for_file: no_leading_underscores_for_library_prefixes
import 'package:clean_architecture/config/functions/_functions.lib.dart' as _i4;
import 'package:clean_architecture/domain/entities/_entities.lib.dart' as _i5;
...
/// A class which mocks [CustomRequestFunc].
///
/// See the documentation for Mockito's code generation for more information.
class MockCustomRequestFunc extends _i1.Mock implements _i4.CustomRequestFunc {
  @override
  Map<String, String> get basicHeaders => (super.noSuchMethod(
        Invocation.getter(#basicHeaders),
        returnValue: <String, String>{},
        returnValueForMissingStub: <String, String>{},
      ) as Map<String, String>);
  @override
  set basicHeaders(Map<String, String>? _basicHeaders) => super.noSuchMethod(
        Invocation.setter(
          #basicHeaders,
          _basicHeaders,
        ),
...
///
/// See the documentation for Mockito's code generation for more information.
class MockRestError extends _i1.Mock implements _i5.RestErrorEntity {
  @override
