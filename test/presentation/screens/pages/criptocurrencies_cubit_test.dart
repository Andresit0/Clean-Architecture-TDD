...
class MockCriptocurrenciesCubitController
    extends MockCubit<CriptoCurrencyListStateEntity>
    implements CriptocurrenciesCubitController {}
...
void main() {
  ...
  Widget testingWidget() {
    CriptocurrenciesCubit.reload = false;
    MyApp.criptocurrenciesCubit = sut;
    return const MyApp();
  }
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.runAsync(() async {
          ...
          final Finder fab = find.bySemanticsLabel('Cubit');
